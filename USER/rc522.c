...
//初始化SPI2
// MCU:   NSS->PB12   SCK->PB13     MOSI->PB15    MISO->PB14   
// RFID:  RST->PA12     CS->PA11
void SPI2_Init(void)	
{
...
// 	  GPIO_InitStructure.GPIO_Pin = GPIO_Pin_14;//MISO PB14
//     GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPU;
//     GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
//     GPIO_Init(GPIOB,&GPIO_InitStructure);
	
		GPIO_InitStructure.GPIO_Pin = GPIO_Pin_11|GPIO_Pin_12;	 //IO-->PA11、PA12 端口配置  ss和rst
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP; 		 //推挽输出
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;		 //IO口速度为50MHz
    GPIO_Init(GPIOA, &GPIO_InitStructure);					    //根据设定参数初始化PA2、PA3
    
		
		GPIO_ResetBits(GPIOA,GPIO_Pin_11|GPIO_Pin_12);			  //PA12输出低:复位    PA11输出低:片选
// 		GPIO_ResetBits(GPIOA,GPIO_Pin_3);			  //PA3输出低:复位    PA2输出低:片选
// 		GPIO_ResetBits(GPIOB,GPIO_Pin_12);		
// 		GPIO_SetBits(GPIOA,GPIO_Pin_2);	
		GPIO_SetBits(GPIOB,GPIO_Pin_12|GPIO_Pin_13|GPIO_Pin_14|GPIO_Pin_15);  //PB12/13/14/15上拉   PB12高电平选定mcu为主机
   //GPIO_SetBits(GPIOB,GPIO_Pin_13|GPIO_Pin_14|GPIO_Pin_15);  //PB12/13/14/15上拉   PB12高电平选定mcu为主机
