...
volatile u32 T4time=0; // us º∆ ±±‰¡ø
volatile u8  chaoshengboF=0; //≥¨…˘≤®±Í÷æ
volatile u32 chaoshengjishu=0;  //≥¨…˘≤®∂® ±∆˜º∆ ˝¥Œ ˝
volatile u32 chaoshengjuli=0;   ////≥¨…˘≤®ºÏ≤‚æ‡¿Î (µ•Œªum)
volatile u32 chaoshengjuliceshi=0;   ////≥¨…˘≤®ºÏ≤‚æ‡¿Î (µ•Œªum)
...
//  ADC1_Init();
  ...
  TIM3_Configuration(); 	 /* TIM3(≥ı ºªØ) ∂® ±≈‰÷√ */
	TIM4_NVIC_Configuration(); /* TIM4(÷–∂œ”≈œ»º∂) ∂® ±≈‰÷√ */
  TIM4_Configuration(); 	 /* TIM4(≥ı ºªØ) ∂® ±≈‰÷√ */
