...
/*±‰¡ø∂®“Â«¯*/
  ...
  u8 WifiStartR=0;
  u8 UploadCardNumber=0,DownloadCardNumber=0;//Õ®–≈÷∏¡Ó÷∏¡Óagv◊∞‘ÿŒª÷√∫Õ–∂‘ÿŒª÷√

//bool T1,T2,T3,T4,T5,clp;  // ‰»ÎDI±‰¡ø
u8 Track; 	 //––∂Ø¬∑œﬂ
u8 FLAG;//Õ®π˝∑«—≠º£∑Ω Ωøÿ÷∆agv––◊ﬂ
u8 qiaoshuo=0;
u8 zhaopan=0;//œﬁ ±Ω” ’£¨‘⁄πÊ∂® ±º‰ƒ⁄Ω” ’≤ªÕÍ’˚‘Ú≈◊∆˙Ω” ’ƒ⁄»›
u8 timeout=0;//”√”⁄Ω” ’≥¨ ±≈–∂œ
...
void JTAGDisable_GPIO_NoRemap(void)
{
		...
		RCC_APB2PeriphClockCmd(RCC_APB2Periph_AFIO, ENABLE);   // πƒ‹AFIO÷ÿ”≥…‰ ±÷”
		GPIO_PinRemapConfig(GPIO_Remap_SWJ_JTAGDisable, ENABLE);  //ø‚∫Ø ˝ µœ÷÷ÿ”≥…‰
...
// 		Delay(50);
	...
	if( (!T1) && (!T2) && (!T3)&& (!T4)&& (!T5)&&((UploadCardNumber!=0) || (DownloadCardNumber!=0)))//»´≤ø±ª’⁄µ≤ ±,»œŒ™Ω¯»ÎºıÀŸ¥¯£¨◊º±∏RFIDºÏ≤‚
	{
...
void RFID_SN_Control(void)  //Read RFID SN ≈–∂œœ‡”¶∂Ø◊˜  99 88 77 66 02
{
